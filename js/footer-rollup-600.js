...
b.insertAfter(".js-movable-toolbar-button-container-marker-desktop"))}};l.MediaQueries={setResizeEvent:function(){var b=this.handleResizeEvent;c(window).on("resize orientationchange",b)},handleResizeEvent:function(){var b=c("#vb-page-body").width();b!=q&&(q=b,(b=vBulletin.contentslider)&&"function"==typeof b.handleWindowResize&&b.handleWindowResize())}};l.checkForVideoSignature=p;(function(){function b(a){var d=a.first(),f=d.position().top,g=d.outerHeight()/2+f,b=!0;a.each(function(a,d){a=c(d);d=
a.position().top;if(d!=f&&(a=a.outerHeight()/2+d,2<Math.abs(a-g)))return b=!1});return b}function e(a){var d=!1;a.each(function(f,g){if(f<a.length-1){var b=c(g),e=a.eq(f+1);f=b.offset();g=e.offset();b=b[0].getBoundingClientRect();e=e[0].getBoundingClientRect();f.bottom=f.top+b.height-1;f.right=f.left+b.width-1;g.bottom=g.top+e.height-1;g.right=g.left+e.width-1;if(!(f.right<g.left||f.bottom<g.top||g.right<f.left||g.bottom<f.top))return d=!0,!1}});return d}function h(a){k.callbacks.push(a)}function m(){var a=
k.callbacks.length,d;for(d=0;d<a;++d)k.callbacks[d]()}(function(a,d){"$:nomunge";var c=a.jQuery||a.Cowboy||(a.Cowboy={}),b;c.throttle=b=function(a,b,f,g){function e(){function c(){k=+new Date;f.apply(l,m)}function e(){h=d}var l=this,n=+new Date-k,m=arguments;g&&!h&&c();h&&clearTimeout(h);g===d&&n>a?c():!0!==b&&(h=setTimeout(g?e:c,g===d?a-n:a))}var h,k=0;"boolean"!==typeof b&&(g=f,f=b,b=d);c.guid&&(e.guid=f.guid=f.guid||c.guid++);return e};c.debounce=function(a,c,f){return f===d?b(a,c,!1):b(a,f,!1!==
c)}})(this);c.extend(k,{areElementsOnOneRow:b,checkElementShrinkRequirement:function(a){var d=a.is(".js-shrink-event-parent");let c=a.is("ul"),g="1"==a.data("vbulletin-shrink-triggered");d=d?a.find("> .js-shrink-event-child").filter(":visible"):c?a.find("> li").filter(":visible"):{length:0};return 1>d.length?g?"need_unshrink":"no_children":!b(d)||e(d)?(a.data("vbulletin-shrink-triggered","1"),"need_shrink"):g?"need_unshrink":"no_change"},checkShrinkEvent:function(a){"undefined"==typeof a&&(a=c(".js-shrink-event-parent"));
let d={need_shrink:"vbulletin:shrink",need_unshrink:"vbulletin:unshrink"};a.each((a,b)=>{a=c(b);b=k.checkElementShrinkRequirement(a);b in d&&a.trigger(d[b])})},init:function(){h(k.checkBrowserSize);h(function(){var a=c(".l-row");1>a.length||a.reverse().each(function(){var a=c(this);if(768<=a.width())return a.removeClass("l-small"),!0;var b=a.find("> .l-col__flex-1, > .l-col__flex-2, > .l-col__flex-3, > .l-col__flex-4, > .l-col__flex-5, > .l-col__flex-6"),e=!1;a.removeClass("l-small");b.reverse().each(function(){if(this.offsetWidth<
...
l()}).insertAfter(a),e.width(a.css("fontSize",e.css("fontSize")).outerWidth()),h=e.width()-h.outerWidth()-parseInt(d.css("paddingLeft"))-parseInt(d.css("paddingRight")),d.width(h);u(e);d=b(".selectBox-label",e);h=parseInt(d.css("paddingLeft"))+parseInt(d.css("paddingRight"))-4;g=e.width()+h;g<=e.parent().innerWidth()&&(e.width(Math.max(g,50)),d.width(d.width()+h));a.addClass("selectBox").data("selectBox-control",e).data("selectBox-settings",c).hide()},t=function(a,c){var e=function(a,c){a.children("OPTION, OPTGROUP").each(function(){if(b(this).is("OPTION"))if(0<
...
var g=function(){0<c.length?(console.log("Ckeditor: Calling getScript for: {0}".format(c[0])),b.getScript(c[0],function(b,a,d){if("success"!=a)return console.warn("Ckeditor: Error loading "+c[0]),e(),!1;console.log("Ckeditor: Script loaded: "+c[0]);c.splice(0,1);g()}).fail(function(b,a,c){console.warn("Ckeditor: Error loading script: "+a+" Exception: "+c);e()})):h()};g()},error_phrase:"error_fetching_dialog"})}};vBulletin.ckeditor.editorExists=function(b){return!1};vBulletin.ckeditor.isEditorEmpty=
function(b){return!0};vBulletin.ckeditor.resetEditor=function(b){return!1};vBulletin.ckeditor.getEditorContent=function(a){a=vBulletin.ckeditor.verifyEditorId(a);return a?vBulletin.ckeditor.editorExists(a)?(a=vBulletin.ckeditor.getEditor(a))&&a.getData?b.trim(a.getData()):!1:b.trim(b("#"+a).val()):!1};vBulletin.ckeditor.focusEditor=function(a){if(a=vBulletin.ckeditor.verifyEditorId(a))vBulletin.ckeditor.editorExists(a)?(a=vBulletin.ckeditor.getEditor(a))&&a.focus():b("#"+a).trigger("focus")};vBulletin.ckeditor.loadingDialogStack=
...
(vBulletin.ckeditor.loadingDialogStack[a]=!1,b("#"+a).prop("disabled",!1),vBulletin.loadingIndicator.hide("vBulletin.ckeditor.hideLoadingDialog editorId: "+a))};vBulletin.ckeditor.generatedIdCounter=0;vBulletin.ckeditor.verifyEditorId=function(a){a=a||"";if("string"==typeof a)return a;if("object"==typeof a&&"undefined"!=typeof a.checkDirty&&"undefined"!=typeof a.name)return a.name;a=a instanceof b?a:b(a);a.attr("id")||(++vBulletin.ckeditor.generatedIdCounter,a.attr("id","vb-cke-instance-"+vBulletin.ckeditor.generatedIdCounter));
return a.attr("id")};vBulletin.ckeditor.initEditorComponents=function(a,c){a=a||document;b(function(){b(".js-ckeditor-init-on-focus",a).off("focus").on("focus",function(){vBulletin.ckeditor.initEditor(b(this))});b(".js-ckeditor-init-on-page-load",a).each(function(){vBulletin.ckeditor.initEditor(b(this))});if(!c){var d=function(c){if(0==c)return b("<span />").html(vBulletin.phrase.get("no_icon")).get(0);var d=b(".js-content-entry-post-icons option",a).filter((a,d)=>b(d).val()==c),e=d.data("icon-url");
return e?(d=d.text(),b("<img />").attr("src",e).attr("alt","").attr("title",d).get(0)):""},e=b(".js-content-entry-post-icons",a);e.selectBox().on("change",function(){var c=b(this).val();b(".js-content-entry-post-icons.selectBox-dropdown .selectBox-label",a).html(d(c))});b(".js-content-entry-post-icons-selectBox-dropdown-menu li a").each(function(){var a=b(this).attr("rel");b(this).html(d(a))});e.trigger("change");b(".js-content-entry-prefixes",a).selectBox();e=b(".js-content-entry-event-highlights-container",
a);var h=e.is(".h-hide-imp");h&&e.removeClass("h-hide-imp");b(".js-content-entry-event-highlights",a).selectBox();h&&e.addClass("h-hide-imp");var g=[];b(".js-select-box",a).each(function(){for(var a=b(this),c;a.is(":hidden");){c=a.closest(".h-hide");if(1>c.length)break;g.push(c);c.removeClass("h-hide")}a.selectBox()});b.each(g,function(b,a){a.addClass("h-hide")})}})};vBulletin.ckeditor.initEditorComponents(document);b(".js-focus-on-page-load").first().trigger("focus");vBulletin.doReplaceSecurityToken=
...
var G=null;vBulletin.flashMessage=function(a){var c=b(".js-flash-message"),d=c.find(".js-flash-message-content");G&&clearTimeout(G);d.text(a);c.removeClass("h-hide").show();G=setTimeout(function(){c.fadeOut(function(){c.addClass("h-hide")})},5E3)};vBulletin.flashPhrase=function(b){vBulletin.flashMessage(vBulletin.phrase.get(b))};bindFormReset=function(a){return b(a).on("reset",function(b,a){"function"==typeof a&&a()})};vBulletin.sitebuilder=vBulletin.sitebuilder||{};vBulletin.sitebuilder.toggleSitebuilder=
function(a){a=b(this);a.hasClass("on")?(x.setCookie("sitebuilder_active",""),b(".js-top-menu-sitebuilder").slideUp("fast"),a.removeClass("on"),a.attr("aria-pressed","false")):(b(".js-top-menu-sitebuilder").slideDown("fast"),a.addClass("on"),a.attr("aria-pressed","true"),x.setCookie("sitebuilder_active","1"))};vBulletin.sitebuilder.setupMenuProxy=()=>{var a=b(".js-top-menu-sitebuilder--list");a.find(".js-top-menu-link:not(.js-top-menu-tab--admincp)").removeClass("b-top-menu__item-link--disabled");
a.on("click.menuproxy",".js-top-menu-link:not(.js-top-menu-tab--admincp)",c=>{w();vBulletin.ready(["sb_page","sb_page_style"]).then(()=>{a.off(".menuproxy");b(c.currentTarget).trigger("click")});return!1})};"undefined"!=typeof tzOffset&&(p=(new Date).getTimezoneOffset()/60,1==Math.abs(tzOffset+p)&&vBulletin.AJAX({call:"/profile/save-dst",data:{userid:pageData.userid,clientUtcOffset:p},success:function(){location.reload()},api_error:b.noop,error:b.noop}));vBulletin.initFlexGridFixLastRowAll=function(b){function a(b){B(".js-flexgrid",
".js-flexgrid-item",".js-flexgrid-image","b-flexgrid__item--lastrow","b-flexgrid__item--lastinrow",!0,b);B(".js-photo-preview",".b-gallery-thumbnail-list__item",".b-gallery-thumbnail-list__thumbnail","b-gallery-thumbnail-list__item--lastrow","b-gallery-thumbnail-list__item--lastinrow",!1,b)}a("undefined"==typeof b?!1:b);vBulletin.Responsive.Debounce.registerCallbackOnce(function(){a(!0)})};vBulletin.initFrameImagesWithColor=function(){H(".js-frame-image-wrapper",".js-frame-image")};setTimeout(function(){function a(){clearTimeout(securitytoken_timeout);
if("guest"!=pageData.securitytoken){securitytoken_timeout=setTimeout(a,36E5);var b=function(){3==++securitytoken_errors&&vBulletin.doReplaceSecurityToken("guest")};vBulletin.AJAX({call:"/ajax/replace-securitytoken",data:{securitytoken:pageData.securitytoken},success:function(b){securitytoken_errors=0;vBulletin.doReplaceSecurityToken(b.newtoken)},api_error:b,error:b})}}b.support.selectstart||b.fn.extend({disableSelection:function(){return this.each(function(){b(this).css({"-moz-user-select":"-moz-none",
...
this);c.val(c.data("link")).off("focus",a).on("focus",a).trigger("focus")}})}})}function h(a){var c=b(`.js-namecard-html[data-userid="${a}"]`);return new Promise((d,e)=>{0<c.length?d(c):(vBulletin.loadingIndicator.show(),vBulletin.AJAX({call:"/ajax/render/user_namecard",data:{userid:a,isAjaxTemplateRender:!0},success:function(a){a&&(c=b(a).filter(".js-namecard-html"),c.appendTo(document.body),d(c))},after_error:function(){e()},complete:()=>{vBulletin.loadingIndicator.hide()}}))})}function g(a){var c=
parseInt(a.data("vbnamecard")||0);if(Number.isNaN(c))return!1;h(c).then(c=>{vBulletin.qtip.apply(a,"",{content:function(a,d){a=b(c[0].outerHTML).removeClass("h-hide-imp");a.find(".js-close-qtip").click(()=>{d.hide()});return a},position:{my:"top center",at:"bottom center",viewport:b(window),adjust:{method:"shift flip"}},show:{solo:!1,ready:!0,event:!1},hide:{event:"unfocus",fixed:!0},style:{classes:"qtip--b-namecard"}})});return!0}function f(a){a.find("input.js-dependent-master").each(function(){var a=
b(this),c=a.attr("type"),d=function(){var c=a.data("action"),d=!a.is(":checked"),e=b(document).find(a.data("on"));"invisible"==c?e.toggleClass("h-invisible",d):"hide"==c?e.toggleClass("h-hide-imp",d):(e.find(":input").addBack(":input").prop("disabled",d),e.find("select").addBack("select").selectBox(d?"disable":"enable"))};if("checkbox"==c)a.on("change",d);else if("radio"==c)a.closest("form").find('input[name="'+a.attr("name")+'"]').on("change",d)})}function n(a){vBulletin.flashMessage(a);a=new URL(location.href);
a.searchParams.delete("flashmsg");var b=document.title;History.replaceState({},b,a.href);document.title=b}function l(){b(".js-full-height").each(function(){var a=b(this),c=a.parent();a.css("height","");a.outerHeight(Math.floor(c.height()),!0)})}function m(a){let c=a=>a.src="core/images/default/google-material/image_placeholder.svg";b("img.js-img-fallback",a).each((a,b)=>{!b.complete||b.naturalWidth&&b.naturalHeight||c(b);b.addEventListener("error",()=>c(b))})}vBulletin.loadingIndicator.init();var p=
b(document);p.off("click","a.animate-scroll").on("click","a.animate-scroll",function(){vBulletin.scrollToAnchor(this.hash)&&(location.href=this.href);return!1});var q=x.createStorage("collapse");p.off("click",".canvas-widget .toggle-button").on("click",".canvas-widget .toggle-button",function(a,c){a=b(this);var d=a.closest(".canvas-widget"),e=b(".widget-content",d),f=d.data("widget-instance-id"),k=a.closest(".edit-mode").length;a.hasClass("expand")?(d.removeClass("collapsed"),c?e.show():e.slideDown("slow"),
k||q.unset(f)):(c?(e.hide(),d.addClass("collapsed")):e.slideUp("slow",function(){d.addClass("collapsed")}),k||q.set(f,1));a.toggleClass("collapse expand");c=a.attr("title");a.attr("title",a.data("toggle-title")).data("toggle-title",c);return!1});(function(){var a=q.getAll("collapse");a&&null!=a&&b.each(a,function(a,c){b("#widget_"+a+":not(.widget-no-header-buttons) .widget-header .toggle-button").trigger("click",[!0])})})();b(".conversation-toolbar-wrapper form.toolbar-filter-overlay").trigger("reset");
a(p);p.on("vb-loadnewposts",function(b,c){a(p,c.insertedHtml)});b(".edit-switch-container .switch-control").on("click",vBulletin.sitebuilder.toggleSitebuilder);vBulletin.sitebuilder.setupMenuProxy();var r=(new URL(location.href)).searchParams.get("adminAction");actionMap={quickConfig:".js-top-menu-tab--quicksetup",stylePanel:".js-top-menu-tab--style",editPage:".js-top-menu-tab--editpage"};$action=b(actionMap[r]);0<$action.length?($action.trigger("click"),"editPage"==r&&vBulletin.ready("history").then(()=>
{let a=new URL(location.href),b=new vBulletin.history.instance(!0);a.searchParams.delete("adminAction");b.pushState({},document.title,a)})):0==pageData.userid&&actionMap[r]&&vBulletin.assertUserHasAdminPermission("canusesitebuilder",self,b.noop,function(){location.reload()});b("select.custom-dropdown").selectBox();p.off("keypress",".js-button").on("keypress",".js-button",function(a){if(32==a.which||13==a.which)a.target&&a.target.nodeName&&"label"==(a.target.nodeName+"").toLowerCase()&&1==b(a.target).find("input").length?
...
b(this).data("languageid"),c=new Date;c.setDate(c.getDate()+365);b.cookie(pageData.cookie_prefix+"languageid",a,{path:pageData.cookie_path,domain:pageData.cookie_domain,expires:c});location.reload();return!1});vBulletin.doReplaceSecurityToken(pageData.securitytoken);securitytoken_timeout=setTimeout(a,36E5);securitytoken_errors=0;vBulletin.initFlexGridFixLastRowAll();vBulletin.initFrameImagesWithColor();I();setTimeout(function(){""!=pageData.crontask&&vBulletin.ajaxtools.ajaxSilent({call:"/ajax/apidetach/cron/"+
pageData.crontask,api_error:b.noop,error:vBulletin.ajaxtools.logAjaxError})},5)},1);vBulletin.triggerHandler=function(a,c,d){c&&0!=c.length?c instanceof b||(c=b(c)):c=b(document);d=d||[];a=b.Event(a);a.target=this instanceof b?this.get(0):this;return c.triggerHandler(a,d)}})(jQuery);function JShtmlEncode(b){var w="";b&&"undefined"!==typeof b&&0<b.length&&(w=$("<div/>").text(b).html());return w=String(w).replace(/"/g,"&quot;")}
...
1),d=vBulletin.makeFilterUrl(d,e,g,b.context)),l.pushState(h,document.title,d),f.data("reset",null))});a(".new-conversations-strip",b.context).off("click.conversation_filter").on("click.conversation_filter",function(){a(this).hide();r=!0;c.updatePageNumber(1);c.applyFilters(!1,!0)});a(".toolbar-filter",b.context).off("click.conversation_filter").on("click.conversation_filter",function(d,c,g){d=a(".filter-wrapper",this);var e=a(this).closest(".conversation-toolbar-wrapper"),f=e.hasClass("bottom")?
"bottom":"top";"undefined"==typeof c&&(c="slow");d.toggleClass("selected");d.attr("aria-expanded",d.is(".selected"));a(".js-expanded-indicator",this).toggleClass("fa-caret-down fa-caret-up");a(".toolbar-filter-overlay",e).slideToggle(c,function(){var d="conversation_filter"+f;if(a(this).is(":visible")){a("body").off("click."+d).on("click."+d,function(c){0==a(c.target).closest(".toolbar-filter-overlay").length&&0==a(c.target).closest(".toolbar-filter").length&&(a("body").off("click."+d),a(window).off("scroll."+
d),c=0<a(c.target).closest(".toolbar-filter").length?"fast":"slow",a(".conversation-toolbar-wrapper.{0} .conversation-toolbar .toolbar-filter".format(f),b.context).triggerHandler("click.conversation_filter",[c]))});var c=!0;if("scroll"!=g){c=a(".filtered-by",b.context);if(0==c.length||c.is(":hidden"))c=this;var e={};(c=vBulletin.isScrolledIntoView(c,e))||a("html,body").animate({scrollTop:"+="+Math.abs(e.bottom)},"fast",function(){setTimeout(function(){if(b.closeOverlayOnScroll)a(window).off("scroll."+
d).on("scroll."+d,function(){a(".conversation-toolbar-wrapper.{0} .conversation-toolbar .toolbar-filter".format(f),b.context).triggerHandler("click.conversation_filter",[0,"scroll"])})},50)})}if(c&&b.closeOverlayOnScroll)a(window).off("scroll."+d).on("scroll."+d,function(){a(".conversation-toolbar-wrapper.{0} .conversation-toolbar .toolbar-filter".format(f),b.context).triggerHandler("click.conversation_filter",[0,"scroll"])})}else a("body").off("click."+d),a(window).off("scroll."+d)});e.hasClass("bottom")&&
a(".arrow .vb-icon",this).hasClass("vb-icon-triangle-up-wide")&&(c=a(".conversation-toolbar-wrapper.bottom .toolbar-filter-overlay",b.context),a("html, body").animate({scrollTop:c.offset().top+c.innerHeight()},500))});a(".filtered-by",b.context).offon("click.conversation_filter",".js-remove-filter",function(){var d=a(this),f=d.closest(".filtered-by"),g=d.closest(".filter-text"),e=g.data("filter-name");a();f.data("clicked",!0);if(!l.isEnabled()&&b.allowHistory)return"text"==g.data("filter-type")&&
g.data("filter-js-selector")?(f=vBulletin.makePaginatedUrl(location.href,1),location.href=vBulletin.makeFilterUrl(f,"q","",b.context,b.hash,!0)):(f=vBulletin.makePaginatedUrl(location.href,1),location.href=vBulletin.makeFilterUrl(f,e,g.data("filter-value"),b.context,b.hash,!0)),!1;var h=a(".toolbar-filter-overlay .filter-options input[name={0}]".format(e),b.context).prop("checked",!1).filter(".js-default-checked");c.updatePageNumber(1);if("text"==g.data("filter-type")&&g.data("filter-js-selector")){a(g.data("filter-js-selector")).val("");
var k=c.getSelectedFilters(a("form.toolbar-filter-overlay",b.context));delete k[e];c.setOption("customFilter",k)}g.remove();g=f.find(".filter-text").length;0==g?(f.addClass("h-hide"),f.data("reset",!0)):1==g&&f.find(".clear-all").addClass("h-hide");1==h.length?(h.data("bypass-filter-display",!0),h.trigger("click.conversation_filter"),h.data("bypass-filter-display",null)):(k&&(f=vBulletin.makePaginatedUrl(location.href,1),f=vBulletin.makeFilterUrl(f,"q","",b.context),l.pushState({from:"filter",page:1,
tab:b.tabParamAsQueryString?"#"+d.closest(".ui-tabs-panel").attr("id"):vBulletin.getSelectedTabHashOrPath(d.closest(".ui-tabs"),!1),filters:k},document.title,f)),c.forceApplyFilters(),k&&c.setOption("customFilter",null))});a(".filtered-by",b.context).offon("click.conversation_filter",".clear-all",function(b){var d=a(this).closest(".conversation-toolbar-wrapper");a(this).data("clicked",!0);c.setOption("customFilter",null);c.resetFilters(!1,!1,d);b.preventDefault()});a(".conversation-toolbar .filter-wrapper",
b.context).data("object-instance",c);a(".js-conversation-showmore-button",b.context).off("click").on("click",function(){var d=parseInt(a('form.toolbar-filter-overlay input[name="pagenum"]',b.context).val());r=!1;c.updatePageNumber(d+1);c.applyFilters(!1,!0,!0)});a(".conversation-toolbar .toolbar-search-form",b.context).off("submit.filtersearch").on("submit.filtersearch",function(){var d=a(this.elements.q),f=a.trim(d.val()),g=a(this).closest(".conversation-toolbar-wrapper");d.val(f);if(!l.isEnabled()&&
b.allowHistory){var e=vBulletin.makePaginatedUrl(location.href,1);location.href=vBulletin.makeFilterUrl(e,"q",f,g);return!1}d=b.tabParamAsQueryString?"#"+a(this).closest(".ui-tabs-panel").attr("id"):vBulletin.getSelectedTabHashOrPath(a(this).closest(".ui-tabs"),!1);if(f){var h=c.getSelectedFilters(g.find(".toolbar-filter-overlay"));e={};e.q=f;a.extend(h,e);c.setOption("customFilter",h);c.forceApplyFilters();c.displayCustomFilterText(this.elements.q);l.isEnabled()&&(e=vBulletin.makePaginatedUrl(location.href,
1),e=vBulletin.makeFilterUrl(e,"q",f,g),l.pushState({from:"filter",page:1,tab:d,filters:h},document.title,e))}else e=g.find('.filter-text[data-filter-name="{0}"]'.format("q")),e.length&&(h=c.getSelectedFilters(g.find(".toolbar-filter-overlay")),c.setOption("customFilter",h),a(".x",e).trigger("click"),l.isEnabled()&&(e=vBulletin.makePaginatedUrl(location.href,1),e=vBulletin.makeFilterUrl(e,"q",f,g),l.pushState({from:"filter",page:1,tab:d,filters:h},document.title,e)));return!1})})();this.isFilterSelected=
function(d){return a('.toolbar-filter-overlay input[value="'+d+'"]',b.context).is(":checked")};this.getSelectedFilters=function(a){return vBulletin.getSelectedFilters(a,!1)};this.resetFilterForms=function(d){if(!d||d instanceof a&&!d.length)d=b.context;a(".toolbar-filter-overlay .js-default-checked",d).prop("checked",!0);a(".toolbar-search-form .js-filter-search",d).val("")};a(".toolbar-filter-overlay, .toolbar-search-form",b.context).trigger("reset");if(l.isEnabled()){m=l.getState();if(!m||a.isEmptyObject(m.data)){a(b.context).hasClass("ui-tabs-panel")?
a(b.context).attr("id"):a(".conversation-toolbar-wrapper",b.context).closest(".ui-tabs-panel").attr("id");var u={from:"filter",page:Number(a(".pagenav-form .defaultpage",b.context).val())||1,tab:vBulletin.getSelectedTabHashOrPath(a(b.context).closest(".ui-tabs"),b.tabParamAsQueryString),filters:c.getSelectedFilters(a("form.toolbar-filter-overlay",b.context))};l.setDefaultState(u,document.title,location.href)}l.setStateChange(function(d,f,g){var e=l.getState();if("filter"==e.data.from||"pagination"==
f||"tabs"==f){l.log(e.data,e.title,e.url);var h;e.data.tab&&(h=b.tabParamAsQueryString?a(e.data.tab):a('.ui-tabs .ui-tabs-panel[data-url-path="'+e.data.tab+'"]'));d=h&&h.length&&h||b.context;if("pagination"==f){if(g){f=a(".filtered-by",d);var k=a(".toolbar-filter-overlay .filter-options-list",d),w=!1;a(".filter-text",f).filter('[data-filter-name!="q"]').remove();a(".clear-all",f).addClass("h-hide");k.find(".js-default-checked").prop("checked",!0);a.each(g,function(b,d){b=a('input[name="{0}"][value="{1}"]'.format(b,
d),k);b.length&&(b.prop("checked",!0).trigger("change",[!0,e.data.page]),w=!0)});w||(k.first().data("bypass-filter-display",!0).trigger("change",[!0,e.data.page]).data("bypass-filter-display",null),f.addClass("h-hide"))}}else g=a(d).closest(".ui-tabs"),f=b.tabParamAsQueryString?g.find('.ui-tabs-nav > li > a[href*="{0}"]'.format(e.data.tab)):g.find('.ui-tabs-nav > li > a[data-url-path="'+e.data.tab+'"]'),f.parent().hasClass("ui-tabs-active")?(g=c.getSelectedFilters(a(".toolbar-filter-overlay",d)),
f=a(".conversation-toolbar .filter-wrapper",d).data("object-instance")||c,vBulletin.areJsonObjectsEqual(g,e.data.filters)||(f.setOption("context",d),f.updatePageNumber(e.data.page),f.applyHistoryFilters(e.data))):(d=f.parent().index(),vBulletin.selectTabByIndex.call(g,d))}},"filter")}this.displayCustomFilterText=function(b,c){n(b,c||a(b).val())};this.isHistoryEnabled=function(){return l.isEnabled()};this.resetFilters=function(d,f,g){if(!g||g instanceof a&&!g.length)g=b.context;var e=a(".filtered-by",
g).addClass("h-hide"),h=location.pathname.replace(/\/page[0-9]+/,"");if(b.tabParamAsQueryString){var k=vBulletin.parseQueryString(location.search);k.tab?h+="?tab="+k.tab:k.view&&(h+="?view="+k.view)}a(".clear-all",e).addClass("h-hide");a(".filter-text",e).remove();c.resetFilterForms(g);if(!d)if(l.isEnabled()){e.data("reset",!0);c.updatePageNumber(1);k=c.getSelectedFilters(a("form.toolbar-filter-overlay",g));if(f){var w=a(".toolbar-search-form .js-filter-search",g).val("");delete k[w.attr("name")];
c.setOption("customFilter",k)}c.forceApplyFilters();u={from:"filter",page:1,tab:b.tabParamAsQueryString?"#"+e.closest(".ui-tabs-panel").attr("id"):vBulletin.getSelectedTabHashOrPath(e.closest(".ui-tabs"),!1),filters:k};l.pushState(u,document.title,h)}else b.allowHistory&&(location.href=h);"function"==typeof b.afterResetFilters&&b.afterResetFilters.apply(this,arguments);return c};this.applyHistoryFilters=function(d){if(d&&d.filters&&!a.isEmptyObject(d.filters)){var f=b.tabParamAsQueryString?a(d.tab):
a('.ui-tabs .ui-tabs-panel[data-url-path="'+d.tab+'"]'),g=a(".toolbar-filter-overlay",f);"undefined"!=typeof c.lastFilters&&delete c.lastFilters;c.resetFilters(!0,!1,f);a.each(d.filters,function(b,c){b=a('[name="'+b+'"]',g);"hidden"==b.attr("type")?b.val(c):"radio"==b.attr("type")&&c!=d.filtervalue&&b.filter('[value="'+c+'"]').prop("checked",!0)});var e=vBulletin.parseQueryString(location.href),h=!0,k=function(){a(".toolbar-search-form .js-filter-search",f).val("")};a.isEmptyObject(e)?k():a.each(e,
function(b,c){var e=a('.filter-options-list input[name="{0}"][value="{1}"]'.format(b,c),g);e.length?d.filtername==b&&d.filtervalue==c?(h=!1,e.prop("checked",!0).trigger("change",[!0])):n(e.get(0)):(e=a('.toolbar-search-form .js-toolbar-search-inner input[name="{0}"]'.format(b),f),e.length&&c?(n(e.get(0),c),e.val(c)):k())});h&&(c.setOption("customFilter",d.filters),c.forceApplyFilters(),c.setOption("customFilter",null))}return c};this.forceApplyFilters=function(){"undefined"!=typeof c.lastFilters&&
delete c.lastFilters;r=!0;c.applyFilters(!1,!0);return c};this.applyFilters=function(d,f,g,e){if("function"==typeof b.beforeApplyFilters&&!1===b.beforeApplyFilters.apply(this,arguments))return c;var h=a(".toolbar-filter-overlay",b.context);f&&clearTimeout(p);var k={filters:b.customFilter?b.customFilter:c.getSelectedFilters(h),isAjaxTemplateRender:!0,isAjaxTemplateRenderWithData:!0};if(a.isEmptyObject(k.filters))return c;d&&(k.filters.checkSince=q,k.filters.pagenum=1);e?r=!0:h.find('input[name="result-id"]').val(0).length&&
(k.filters["result-id"]=0);if("undefined"!=typeof this.lastFilters&&vBulletin.areJsonObjectsEqual(this.lastFilters.filters,k.filters)&&!d)return c;this.lastFilters=k;var l=a(".conversation-empty",b.context),m=a(".conversation-toolbar-wrapper",b.context);m.addClass("h-disabled");l.addClass("h-invisible");d&&window.vBulletin.loadingIndicator.suppressNextAjaxIndicator();var n=vBulletin.normalizeAjaxUrl(h.attr("action"))||vBulletin.getAjaxBaseurl()+"/activity/get",u=h.closest(".conversation-toolbar-wrapper").find('form.pagenav-form input[name="article_display_columns"]');
1==u.length&&(k.article_display_columns=u.val());var v=a(".conversation-list",b.context);vBulletin.AJAX({url:n,data:k,api_error:function(a){a=a[0];v.addClass("h-hide");a=vBulletin.phrase.get(a);l.html((a||"").replace(/<br\s*\/*>/g," ")).removeClass("h-hide h-invisible")},success:function(e){l.addClass("h-hide");if(d)!t&&0<e.total&&!a("body").hasClass("edit-mode")&&(a(".new-conversations-strip span",b.context).html(e.total),a(".new-conversations-strip",b.context).fadeIn("slow")),0==a(".conversation-list li.list-item",
b.context).length&&l.removeClass("h-hide");else{var f=a(".js-conversation-showmore",b.context);a(".new-conversations-strip",b.context).hide();if((0<e.total_with_sticky||0<e.total)&&e.template){e.resultId&&(a('input[name="result-id"]',h).val(e.resultId).length&&this.lastFilters&&(this.lastFilters.filters["result-id"]=e.resultId),b.pagination&&b.pagination.updateResultId(e.resultId));g?v.append(e.template):(l.addClass("h-hide"),v.html(e.template).removeClass("h-hide"));e.fixFlexGrid&&vBulletin.initFlexGridFixLastRowAll();
var m=k.filters,n=parseInt(m.maxpages);m=parseInt(m.pagenum);var p=e.pageinfo;n=n&&m>=n||p&&(m>=parseInt(p.totalpages)||!1===p.showseemore);f.toggleClass("h-hide",n)}else g||(l.removeClass("h-hide"),v.addClass("h-hide").empty());0==e.total_with_sticky&&f.addClass("h-hide");r&&b.scrollToTop&&(f=b.scrollToTop instanceof a?b.scrollToTop:a(b.scrollToTop),0<f.length&&a("body,html").animate({scrollTop:f.offset().top},"slow"));q=e.lastDate;"function"==typeof b.onContentLoad&&b.onContentLoad.apply(v.get(0),
[e]);e.pageinfo&&(c.updatePageNumber(e.pageinfo.pagenumber||1),b.pagination&&"function"==typeof b.pagination.updatePageInfo&&(b.pagination.setOption("context",b.context),b.pagination.updatePageInfo(e.pageinfo,!0)));vBulletin.inlinemod&&"function"==typeof vBulletin.inlinemod.init&&0<a(".moderationmenu_container",b.context).length&&vBulletin.inlinemod.init(b.context);a(document).trigger("vb-filterposts",{parentOfInsertedHtml:v})}t&&(t=!1)},error_phrase:"unable_to_contact_server_please_try_again",complete:function(){m.removeClass("h-disabled");
l.removeClass("h-invisible");!t&&b.autoCheck&&p&&(p=setTimeout(c.checkNewConversations,b.checkInterval))}});return c};this.updatePageNumber=function(d){d=Number(d);0<d&&a('form.toolbar-filter-overlay input[name="pagenum"]',b.context).val(d);return c};this.checkNewConversations=function(){a("body").hasClass("edit-mode")||(console.log("Checking for new activity since "+q),c.applyFilters(!0));return c};this.toggleNewConversations=function(a){a?(b.autoCheck=!0,p=setTimeout(c.checkNewConversations,b.checkInterval)):
(b.autoCheck=!1,clearTimeout(p));return c};this.hideFilterOverlay=function(){a(".conversation-toolbar-wrapper .toolbar-filter-overlay",b.context).filter(":visible").each(function(){a(this).prev(".conversation-toolbar").find(".toolbar-filter").triggerHandler("click.conversation_filter",[0])});return c};this.getOption=function(a){return b[a]};this.setOption=function(a,f){b[a]=f;return c};b.autoCheck&&(q=pageData.current_server_datetime,p=setTimeout(c.checkNewConversations,b.checkInterval))};vBulletin.conversation.displaySelectedFilterText=
...
$.extend(vBulletin.conversation,function(b,g){function r(a){var f=b(this),d,c=f.closest(".conversation-list");0<f.closest(".js-comments").length&&(d="comment");var e=b(".edit-conversation-container form",c);if(0<e.length)vBulletin.warning("edit_conversation","you_have_a_pending_edit_unsaved",function(){vBulletin.animateScrollTop(e.closest(".js-post").offset().top,{duration:"slow"})});else{vBulletin.loadingIndicator.show();a.preventDefault();var l=f.parent().attr("data-node-id"),h="comment"==d?f.closest(".js-comment"):
f.closest(".js-post__content-wrapper");var g=c.hasClass("thread-view")?"thread":c.hasClass("full-activity-view")?"full-activity-stream":c.hasClass("activity-view")?"activity-stream":"stream";d=d||h.attr("data-node-type")||"";a=b(".js-show-post-link",h).text()||"1";var k="comment"!=d||"thread"!=g&&1!=c.closest(".blog-conversation-content-widget").length?Number(a.replace("#",""))-1:Number(a.replace("#",""));var m=function(a,c,e,n){var p=b(".edit-conversation-container form",h).data("content-type");
!1===vBulletin.triggerHandler.apply(n.get(0),["afterSave",b(document),a])?(b("body").trigger(p+"_editform_onunload",[h]),window.vBulletin.loadingIndicator.hide()):(c=pageData,c["posts-perpage"]=vBulletin.conversation.POSTS_PER_PAGE,"thread"==g&&(c["comments-perpage"]=vBulletin.conversation.COMMENTS_PER_PAGE),a&&vBulletin.ajaxtools.hasError(a.warnings,"warning_spam_post")?vBulletin.ajaxtools.showApiError(a.warnings,a,{title_phrase:"warning",after_error:function(){a.warningReturnUrl?location.href=a.warningReturnUrl:
window.location.reload(!0)}}):b.post(vBulletin.getAjaxBaseurl()+"/create-content/loadnode",{nodeid:l,view:g,index:k,page:c,type:d,isAjaxTemplateRender:!0,isAjaxTemplateRenderWithData:!0},function(a){if(a.error)openAlertDialog({title:vBulletin.phrase.get("conversation"),message:vBulletin.phrase.get(a.error),iconType:"error"});else{var c=n.closest(".js-content-entry").data("current-channelid"),d=n.find('input[name="parentid"]:checked').val();if(0<c&&0<d&&c!=d)location.reload(!0);else{b("body").trigger(p+
"_editform_onunload",[h]);c=b(a.template);d=f.closest(".js-post");var e=d.parent();d.replaceWith(c);c=e.find(".js-post").filter((a,c)=>b(c).data("node-id")==l);a.hasOwnProperty("template_article_title_info")&&(d=b(".js-update-article-title-info"),e=b(a.template_article_title_info),0<d.length&&d.empty().append(e));b("body").trigger(p+"_newcontent_onload",[c]);b(document).trigger("vb-loadnode",{insertedHtml:c,context:"conversationcommon"});c.hasClass("js-conversation-starter")&&(d=b(".js-post-title",
c).first().text(),e=d+" - "+vBulletin.options.get("bbtitle"),"topic_url"in a&&(a=pageData.baseurl+a.topic_url,a!=location.href&&window.history.replaceState({},e,a)),document.title=e,b(".page-title-widget .js-main-title").text(d));b(".js-select-box",c).selectBox();vBulletin.animateScrollTop(c.offset().top,{duration:"slow"})}}},"json").error(function(){openAlertDialog({title:vBulletin.phrase.get("conversation"),message:vBulletin.phrase.get("error_loading_post"),iconType:"error"})}).complete(function(){window.vBulletin.loadingIndicator.hide()}))};
b.post(vBulletin.getAjaxBaseurl()+"/create-content/loadeditor",{nodeid:l,type:d,view:g,isAjaxTemplateRender:!0},function(a,c){if(c)vBulletin.error("edit_conversation",c[0]);else{var d=function(){if("undefined"==typeof vBulletin.upload||"undefined"==typeof vBulletin.tagEditor||"undefined"==typeof vBulletin.contentEntryBox.init)vBulletin.ckeditor.loadScripts("",{},d);else{h.addClass("b-post--edit");h.find(".js-post__content").first().addClass("b-post__content--edit");h.find(".b-post__footer").first().addClass("b-post__footer--edit");
$container=h.find(".edit-conversation-container").first();h.closest(".js-album-detail").find(".conversation-body, .profile-media-uploadphotos, .js-photo-preview").addClass("h-hide-imp");vBulletin.contentEntryBox.init();vBulletin.hv.init($container.find(".js-human-verification"));vBulletin.contentEntryBox.setDefaultTab($container.find(".js-content-entry").first());$container.show();vBulletin.loadingIndicator.hide();var a=$container.find(".js-attach-list");vBulletin.upload.initializePhotoUpload(h);
var c=".js-post[data-node-id={0}] .tag-editor-container .tag-input".format(l);$tagEditorBox=b(c);0<$tagEditorBox.length&&"undefined"!=typeof vBulletin.tagEditor&&new vBulletin.tagEditor.instance(c);0<a.data("attach-count")&&(a=$container.find(".b-toolbar__item").filter(function(){return"b-content-entry-panel__content--attachment"==b(this).data("panel")}),a.hasClass("b-toolbar__item--active")||a.trigger("click"));vBulletin.contentEntryBox.afterPanelChange(h);vBulletin.flatpickr&&vBulletin.flatpickr.initPickers()}};
console.log("Edit mode: Adding Content Entry UI to DOM (contains parsed post text in the .js-editor-parsed-text element)");b(".edit-conversation-container",h).first().hide().html(a);var f=b(".edit-conversation-container form",h).data("content-type");b(window).off("beforeunload.editPost").on("beforeunload.editPost",function(){return vBulletin.phrase.get("onbeforeunload_message_while_editing_post")});b("body").trigger(f+"_editform_onload",[h,d]);vBulletin.ajaxForm.apply(b("form.js-contententry-form",
h),[{dataType:"json",success:m,beforeSerialize:function(a){console.log("ajaxForm beforeSerialize (vBulletin.conversation.editPost)");a.trigger("beforeSave");return!1===b("body").triggerHandler(f+"_editform_onbeforeserialize",[a])?!1:!0},beforeSubmit:function(a,c,d){if(!1===vBulletin.contentEntryBox.validateForm.apply(c,[d]))return!1;b(window).off("beforeunload.editPost");window.vBulletin.loadingIndicator.show();return!0},complete:function(){window.vBulletin.loadingIndicator.hide();console.log("ajaxForm complete (vBulletin.conversation.editPost)")}}])}},
"json").error(function(a,c,b){openAlertDialog({title:vBulletin.phrase.get("edit_conversation"),message:"HTTP {0} - {1}".format(a.status,b),iconType:"error"})}).complete(function(a,c,b){window.vBulletin.loadingIndicator.hide()})}}function m(a,f=3){var d=0,c=b("ul.poll li",a),e=parseInt(c.css("line-height"),10);c.each(function(a){b(this).removeClass("h-hide");a=b(this).height();d+=a/e;d>f?b(this).addClass("h-hide"):b(this).css("display","")});c=d>f;b(".view-more-ctrl",a).toggleClass("h-hide-imp",!c).next(".js-button-group").toggleClass("h-hide",
c).next(".view-less-ctrl").toggleClass("h-hide-imp",c)}function k(a){return a.closest(".js-post").data("node-id")}function t(){var a=b(this),f=a.data("post-ip");a.data("post-host");e.register(["ip_info","ip_address_is","host_name_is","no_ip_found"]);f?(openAlertDialog({title:e.get("ip_info"),message:e.get("ip_address_is")+": "+f+"<br />"+e.get("host_name_is")+': <span class="ip-host-name loading">...</span>',iconType:"none"}),g.AJAX({call:"/ajax/api/node/getHostName",data:{ip:f},success:function(a){b(".ip-host-name").removeClass("loading").html(a)}})):
g.alert("ip_info","no_ip_found");return!1}function u(){var a=k(b(this)),f=q({title:e.get("flag_a_post"),message:e.get("please_enter_your_reason_why_you_want_to_flag_this_post"),buttonLabel:{okLabel:e.get("send_report"),cancelLabel:e.get("cancel")},multiline:!0,validation:{callback:q.validationString,showError:!0},onClickOK:function(d){b("body").css("cursor","wait");g.AJAX({call:"/report/report",data:{reason:d,reportnodeid:a},success:function(a){f.dialog("close");g.alert("flag_a_post","the_report_has_been_sent")},
complete:function(){b("body").css("cursor","default")},error_phrase:"unable_to_contact_server_please_try_again",title_phrase:"flag_a_post"});return!1}});return!1}function v(){var a=b(this).closest(".js-comment-entry__parent").find(".js-comment-entry");a.slideToggle("fast",function(){var a=b(this).find(".js-comment-entry__textbox");a.is(":visible")&&a.trigger("focus")});a.find(".js-comment-entry__cancel").offon("click.convocom",function(b){a.slideToggle();return!1});return!1}function w(){function a(a,
b,d){d.isAjaxTemplateRenderWithData=!0;g.AJAX({call:"/ajax/render/"+b,data:d,success:function(b){a.removeClass("loading").find(".dialog-content .message").html(b.template).end().dialog("option","position",{of:window})},after_error:function(){a.dialog("close")}})}var f=k(b(this)),d=openConfirmDialog({title:e.get("post_history"),message:e.get("loading")+"...",width:800,dialogClass:"post-history-dialog dialog-container dialog-box loading",buttonLabel:{yesLabel:e.get("compare_versions"),noLabel:e.get("cancel")},
onAfterClose:function(){if("btnConfirmDialogYes"==this.id){var c=d.find(".post-history-form");b("#btnConfirmDialogYes").hide();var g=openConfirmDialog({title:e.get("post_history"),message:e.get("loading")+"...",width:800,dialogClass:"post-history-comparison-dialog dialog-container dialog-box loading",buttonLabel:{yesLabel:e.get("compare_versions"),noLabel:e.get("close")},onAfterClose:function(){b("#btnConfirmDialogYes").show()}});c={oldpost:c.find("input:radio[name=old]:checked").val()||1,newpost:c.find("input:radio[name=new]:checked").val()||
1,nodeid:f};a(g,"post_history_form",c)}}});a(d,"post_history_form",{nodeid:f})}function x(){var a=b(this),f=k(a);a=!a.closest(".js-post").hasClass("isanswer");var d=vBulletin.getSelectedFilters(b(".toolbar-filter-overlay"));b("body").css("cursor","wait");g.AJAX({call:"/create-content/setExclusiveAnswer",data:{nodeid:f,set:a?1:0,searchFilters:d,isAjaxTemplateRender:!0,isAjaxTemplateRenderWithData:!0},success:function(a){b(".js-post.isanswer").toggleClass("isanswer",!1);a.answers&&0<a.answers.length&&
a.answers.forEach(a=>{b(".js-post[data-node-id="+parseInt(a,10)+"]").toggleClass("isanswer",!0)});let c=b(".js-post.pinned-answer");c.length&&c.hide("slow",()=>{c.remove()});if(a.template){var d=b(".js-conversation-starter");a=b(a.template);a.hide();a.insertAfter(d).show("slow")}},complete:function(){b("body").css("cursor","default")},error_phrase:"unable_to_contact_server_please_try_again",title_phrase:"setasanswer"});return!1}var e=g.phrase,q=g.openPromptDialog;return{initContentEvents:function(a){a.offon("click.convocom",
".js-post-control__ip-address",t);a.offon("click.convocom",".js-post-control__edit",r);a.offon("click.convocom",".js-post-control__flag",u);a.offon("click.convocom",".js-post-control__comment",v);a.offon("click.convocom",".js-post__history",w);a.offon("click.convocom",".js-post-control__answer",x)},initPollEvents:function(a){a.offon("click.convocom",".list-item-poll .view-more-ctrl",function(a){var d=b(this).closest("form.poll");a=d.find("ul.poll");b(this).addClass("h-hide-imp");a.css("max-height",
"none").find("li.h-hide").slideDown(100,function(){d.find(".js-button-group").removeClass("h-hide").next(".view-less-ctrl").removeClass("h-hide-imp");g.animateScrollTop(d.offset().top,{duration:"fast"})});return!1});a.offon("click.convocom",".list-item-poll .view-less-ctrl",function(a){a=b(this).closest("form.poll");m(a,3);a.find("ul.poll").css("max-height","").find("li.h-hide").slideUp(100);return!1})},limitVisiblePollOptionsInAPost:m}}(jQuery,vBulletin));
;
...
g=l.find('input[name="filter_sort"]:checked').val();l=l.find('input[name="filter_order"]:checked').val();vBulletin.AJAX({call:"/ajax/render/blogmember_tab",data:{from:e,my:c,display_blogs:h,noToolbar:f,page:m,blogChannelId:d.data("blog-channel-id"),sort_field:g,sort_order:l},error_phrase:"unable_to_contact_server_please_try_again",success:function(g){let c=b(g);c.filter(".conversation-toolbar-wrapper").length?(a.html(g),I(a),a.trigger("vb-instrument")):(b(".blogmember-list",a).hide().replaceWith(c).show(),
...
a.data("vb-exclude-item-container",c),b.each(function(a,b){a=d(this);d("<li />").addClass("js-excluded-item-marker h-hide-imp").data("vb-excluded-item",a).insertAfter(a)}),b.appendTo(c))):(c=a.data("vb-exclude-item-container"),b=a.find(".js-excluded-item-marker"),c&&c.length&&0<c.length&&0<b.length&&(b.each(function(a,b){a=d(this);a.data("vb-excluded-item").insertAfter(a)}),b.remove(),a.data("vb-exclude-item-container",!1),c.remove()))});k(function(a,c,b){function f(a){a=d(this).closest("li");g.removeClass("b-comp-menu-dropdown__content-item--current ui-tabs-active ui-state-active ui-state-hover ui-state-default");
a.addClass("b-comp-menu-dropdown__content-item--current")}if(a.is(".js-module-tab-menu")){var h=a.closest(".widget-tabs-nav, .js-widget-tabs-nav"),n=h.find(".module-title, .js-module-title"),g=a.find("li"),k=g.filter(".ui-state-active"),l=a.find("a");h.addClass("js-widget-tabs-nav");n.addClass("js-module-title");"dropdown"==b?((a.is(".js-profile-tabs-nav")||a.is(".js-subscribe-tabs-nav"))&&d("<div />").addClass("js-profile-menu-wrapper widget-tabs-nav").insertAfter(a).append(c).append(a),e(a,["ui-tabs-nav",
"ui-helper-reset","ui-helper-clearfix","ui-widget-header","ui-corner-all"],[]),e(c,[],["js-select-when-dropdown"]),e(h,["widget-tabs-nav"],["widget-tabs-nav-background"]),e(n,["module-title"],[]),e(g,"ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all ui-corner-bottom ui-corner-top ui-corner-right ui-corner-left ui-corner-br ui-corner-bl ui-corner-tr ui-corner-tl".split(" "),[]),e(l,["ui-tabs-anchor","h-block"],[]),k.length?k.addClass("b-comp-menu-dropdown__content-item--current"):
setTimeout(function(){g.filter(".ui-state-active").addClass("b-comp-menu-dropdown__content-item--current");var b=a.next(".vb-select-el"),c=0;if(b&&b.length){g.each(function(a,b){c=a;if(d(b).is(".ui-state-active"))return!1});var e=b.is(".selectBox");e&&b.selectBox("destroy");b.find(".js-noop-label").remove();b.get(0).selectedIndex=c;e&&b.selectBox()}},0),g.removeClass("ui-state-default ui-tabs-active ui-state-active ui-state-hover"),l.off("click.vbmoduletabs").on("click.vbmoduletabs",f),c.data("add-classes-to-select-el",
"h-margin-vert-m h-margin-horiz-xl")):(g.filter(function(){return"true"==d(this).attr("aria-selected")}).removeClass("b-comp-menu-dropdown__content-item--current").addClass("ui-tabs-active ui-state-active"),l.off("click.vbmoduletabs"),m(h),m(n),b=a.parent(),b.is(".js-profile-menu-wrapper")&&(a.insertAfter(b),c.insertAfter(b),b.remove()))}});k(function(a,c,b){if(a.is(".js-tabbed-pane__tabs")){var f=a.find("li"),h=f.filter(".b-tabbed-pane__tab--selected");a.find("a");"dropdown"==b?(d("<div />").addClass("js-tabbed-pane__tabs-wrapper b-tabbed-pane_tabs b-tabbed-pane__tabs--standard").insertAfter(a).append(c).append(a),
e(a.parent(),[],["js-comp-menu-dropdown__content"]),e(c,[],["js-select-when-dropdown"]),e(f,[],["b-comp-menu-dropdown__content-item"]),h.addClass("b-comp-menu-dropdown__content-item--current"),c.data("add-classes-to-select-el","h-margin-horiz-xl h-margin-vert-m")):(f.removeClass("b-comp-menu-dropdown__content-item--current"),b=a.parent(),b.is(".js-tabbed-pane__tabs-wrapper")&&(a.insertAfter(b),c.insertAfter(b),b.remove()))}});k(function(a,c,b){a.is(".js-groupblog-admin-menu")&&(a.closest(".js-blog-admin-left"),
a=a.find("li").filter(".sgAdminActive, .blogAdminActive"),"dropdown"==b&&(e(c,[],["js-select-on-xsmall"]),a.addClass("b-comp-menu-dropdown__content-item--current")))});k(function(a,c,b){if(a.is(".js-sharing-menu")){var d=a.find("li");"dropdown"==b?(b=a.prevAll(".userinfo"),1==b.length&&(c.appendTo(b),a.data("vb-moved-to-userinfo","1")),e(a,["b-sharing-menu--horizontal"],[]),e(c,[],["h-align-bottom"]),e(d,[],["b-comp-menu-dropdown__content-item--no-hover","js-comp-menu-dropdown__content-maintain-menu"])):
("1"==a.data("vb-moved-to-userinfo")&&(b=c.parent(".userinfo"),a.insertAfter(b).data("vb-moved-to-userinfo","0")),m(d))}});let t=()=>q(d(".js-comp-menu-horizontal, .js-comp-menu-column"));d(document).on("vb-tabinit",a=>{q(d(a.target).find(".js-comp-menu-horizontal, .js-comp-menu-column"))});d(function(){vBulletin.phrase.register(d("[data-dropdown-trigger-phrase]").map(function(a,c){return d(c).data("dropdown-trigger-phrase")}).get());q(d(".js-comp-menu-horizontal, .js-comp-menu-column").filter(":not(.ui-tabs-nav)"));
1>r.init&&(l.registerCallback(t),d(document).on("vb-loadnewposts vb-filterposts",t));r.init++});return{registerMenuChangeFilter:k,checkHorizontalMenuState:t,convertDropdownProgressive:function(a){if(!(1>a.$children.length||1!=a.$parent.length)){a.needsShrink=a.needsShrink||function(){return"need_shrink"==l.checkElementShrinkRequirement(a.$parent)};a.copyChild=a.copyChild||function(a){var b=a.find("> a");a=d('<a href="#"></a>');a.html(b.html());a.attr("href",b.attr("href"));a.on("click",function(){b.trigger("click");
...
"pm-reply"),History.replaceState({},B,pageData.baseurl_pmchat+"?messageid="+a),p(a)):console.log("Missing nodeid for loadParticipants()")}function C(){T.trigger("event-js-element-resize")}function p(b,e){vBulletin.AJAX({call:"/chat/loadparticipants",data:{nodeid:b},success:function(b){var c=a(".js-pmchat__participants-insert-marker");b.participants_html&&""!=b.participants_html&&c.length&&(c.html(b.participants_html),aa.trigger("event-js-content-change"));I.hasClass("h-hide")&&(I.removeClass("h-hide"),
ea.trigger("click"),ba.removeClass("h-hide"));b.phrase&&""!=b.phrase&&(a(".js-participants-count-phrase").text(b.phrase),a(".js-participants-count-phrase--title").prop("title",b.phrase));b.title&&""!=b.title&&a(document).find("title").html(b.title);if(e&&e.success&&"function"==typeof e.success)return e.success.apply(this,[b])},complete:function(a,b,d){if(e&&e.complete&&"function"==typeof e.complete)return e.complete.apply(this,[a,b,d])},error:function(a,b,e){console.log("/ajax/chat/loadparticipants failed!");
console.log("----------------");console.log("jqXHR:");console.dir(a);console.log("text status:");console.dir(b);console.log("error thrown:");console.dir(e);console.log("----------------")}})}function K(b){var e=a(this).attr("href");e.startsWith("#")||(b.preventDefault(),(b=window.open(e,"_blank"))&&!b.closed&&"undefined"!=typeof b.closed||window.open(e))}function R(a){ba.animate({height:"toggle"},{duration:"fast",start:function(){aa.trigger("event-js-element-resize-start")},progress:function(a,b,
c){C()},complete:function(){C()}});a.preventDefault();fa.length&&fa.toggleClass("fa-caret-down fa-caret-up")}function V(){var b=function(a){var b=0<aa.height();if(a.data&&a.data.command)switch(a.data.command){case "open":x.removeClass("h-hide");break;case "close":x.addClass("h-hide");break;default:b?x.toggleClass("h-hide"):x.removeClass("h-hide")}else x.toggleClass("h-hide");b?C():R(a);a.preventDefault()},e={},d=a(".js-participants-add-recipients-input"),c=new vBulletin_Autocomplete(d,{apiClass:"user",
afterAdd:function(a,b,c){"undefined"!=typeof c&&"undefined"!=typeof c.id&&c.id&&(e[b]=c.id)},delimiter:" ; "}),f=function(a){c.clearElements();a.data?a.data.command="close":a.data={command:"close"};b(a)};console.log({addRecipientsAutoComplete:c});ha.off("click").on("click",{command:"toggle"},b);x.find(".js-add-recipients-cancel").off("click").on("click",{command:"close"},f);x.find(".js-add-recipients-submit").off("click").on("click",function(a){var b=c.getInputField(),d=b.val();d&&(b.val(""),c.addElement(d,
d));b=c.getValues();vBulletin.AJAX({call:"/ajax/api/content_privatemessage/addPMRecipientsByUsernames",data:{pmid:q,usernames:b,usernamesToIds:e},success:function(b){p(q,{success:function(){f(a);t.messagesLoading?t.queued=!0:r()},complete:function(){window.vBulletin.loadingIndicator.hide()}})}})})}function y(b){function e(){if("fixed"==c.css("position")){f.removeClass("h-hide");var a=c.outerHeight()-30;f.css("height",a+"px")}else f.addClass("h-hide")}var d=b+"-replacement",c=a("."+b),f=a("."+d);0==
f.length&&(f=a("<div />").addClass(d).insertAfter(c));a(e);a(document).off("click",e).on("click",e);vBulletin.Responsive.Debounce.registerCallback(e);CKEDITOR.on("instanceReady",function(a){e();a.editor.on("focus",function(){setTimeout(function(){e()},0)})});c.on("event-js-element-resize",e)}var h=a(".js-pmchat__container"),I=a(".js-pmchat__participants"),E=h.find(".js-pmchat__thread-container"),b=h.find("form"),d=h.find(".js-pmchat__data");h=parseInt(d.data("pmchannelid"),10);var q=parseInt(d.data("parentid"),
10),v=parseInt(d.data("pm_messageid"),10),n=parseInt(d.data("to_userid"),10),B=d.data("pm_title"),w=0,D=0,W=a(".js-pmchat__insert-marker"),P=E.find(".js-pmchat__thread-placeholder"),A,f=!1;h!=q&&0<v||(f=!0);var F=0,G,u=Date.now(),N,m=vBulletin.options.get("pmchat_chat_polling_min_interval")||1,l=vBulletin.options.get("pmchat_chat_polling_max_interval")||30;l<m&&(h=l,l=m,m=h);var g=N=(10*m+1*l)/11;var ca=vBulletin.options.get("pmchat_chat_polling_idle_timeout")||300,H=0,L=9,M=[];for(h=0;10>h;++h)M[h]=
0;var t={messagesLoading:!1,queued:!1},S=!1,T=a(".js-pmchat__header"),ea=a(".js-participants-collapser-ui"),fa=a(".js-participants-toggle-arrow"),ba=a(".js-participants-collapsible"),aa=ba.find(".js-vbscroller-wrapper"),ha=a(".js-participants-show-add-recipients-ui"),x=a(".js-participants-add-recipients-wrapper"),U=b.find(".js-wrapper-contententry_title"),da=b.find(".js-wrapper-contententry__msgRecipients");new vBulletin_Autocomplete(a(".privatemessage_author"),{apiClass:"user",delimiter:" ; "});
a(".js-pm-content-entry-container .js-pmchat-submit").off("click").on("click",function(g){function e(b,e,d){a("<input>").attr({type:"hidden",name:e,value:d}).appendTo(b)}var h=a(this);h.prop("disabled",!0);u=Date.now();f?(0==b.find('input[name="msgRecipients"]').length&&n?(console.log({msg:"sentto input added with prefill:",to_userid:n}),e(b,"sentto[]",n)):console.log({msg:'User editable input[name="msgRecipients"] was found. Prefilled sentto skipped.'}),0==b.find('input[name="title"]').length?(console.log({msg:"title input added with prefill:",
pm_title:B}),e(b,"title",B)):console.log({msg:'User editable input[name="title"] was found. Prefilled title skipped.'})):(g=b.find('input[name="respondto"]'),0<g.length?g.val(v):e(b,"respondto",v),0==b.find('input[name="msgtype"]').length&&e(b,"msgtype","message"));f&&P.addClass("h-hide");vBulletin.loadingIndicator.show();vBulletin.AJAX({url:b.attr("action"),data:b.serialize(),success:function(c){c.nodeId&&(c=parseInt(c.nodeId,10),f&&(b.find('input[name="parentid"]').val(c),d.data("parentid",c),d.data("pm_messageid",
c),d.attr("data-parentid",c),d.attr("data-pm_messageid",c),q=v=c,f=!1,J(c)),console.log("==================NEW MESSAGE POSTED, LOADING NEW MESSAGES!"),t.messagesLoading?t.queued=!0:r(c),vBulletin.contentEntryBox.resetForm(b,!1,function(){var c=b.attr("ck-editorid")||a(".js-editor",b).attr("id");c=vBulletin.ckeditor.getEditor(c);vBulletin.hv.reset();c.focus()}))},api_error:vBulletin.hv.resetOnError,complete:function(a){vBulletin.loadingIndicator.hide();h.prop("disabled",!1)}});return!1});h="a:not('.js-pmchat-ignoreanchor')";
var X=`.js-namecard-html ${h}`;vBulletin.options.get("usenamecard")&&(h+=":not([data-vbnamecard])",a("body").on("click",X,K));E.on("click",h,K);I.on("click",h,K);a("body").on("click","a.js-pmchat-ignoreanchor",function(a){a.preventDefault()});ea.off("click").on("click",R);0<ha.length&&0<x.length&&V();a(".js-pm-content-entry-container .js-button").enable();k();z();(function(){a(document).on("click keypress scroll",function(a){S=!0});var d=b.attr("ck-editorid")||a(".js-editor",b).attr("id");a("#"+d).on("afterInit",
function(){var a=vBulletin.ckeditor.getEditor(d);a.on("contentDom",function(){function b(){S=!0}var c=a.editable();null!=c&&(c.attachListener(c,"keypress",b),c.attachListener(c,"click",b),c.attachListener(c,"focus",b))})})})();window.setTimeout(function(){var f=b.attr("ck-editorid")||a(".js-editor",b).attr("id");a("#"+f).on("afterInit",function(){var a=vBulletin.ckeditor.getEditor(f);if(a){console.log("Setting predefined starter PM text: "+d.data("pm_textprefill"));var b=d.data("pm_textprefill");
b&&(b+="&nbsp;");a.setData(b,function(){vBulletin.ckeditor.fixTableFunctionality.call(vBulletin.ckeditor,{},a);var c=da.find(".autocompleteHelper");0<c.length?c.trigger("focus"):a.focus();b&&(c=a.createRange(),c.moveToPosition(c.root,CKEDITOR.POSITION_BEFORE_END),a.getSelection().selectRanges([c]));k()})}else console.log("Editor not found, cannot set predefined starter PM text")})},0);y("js-pm-content-entry-container");y("js-pmchat__header");(function(){var b=a("#debug-information");if(1==b.length){var d=
function(){a("body").is(".l-xsmall")?b.appendTo("body"):b.insertBefore(".js-pm-content-entry-container")};d();vBulletin.Responsive.Debounce.registerCallback(d)}})()}var T=pageData.baseurl_pmchat;(function(){a(function(){a("body").off("click",".js-pmchat-link").on("click",".js-pmchat-link",function(k){k.preventDefault();k={url:a(this).attr("href")};G(k);return!1});var k=a(".js-pmchat__dropdown");0<k.length?k.attr("data-initialized")?console.log("PM Dropdown already initialized. Skipping re-init."):
...
// ***************************
(function(){function m(k,d){function n(){c.data("nodeid",null);c.toggleClass("vb-pop-open",!1)}function p(b,a,c=!1){k.AJAX({call:"/ajax/api/reactions/"+(c?"unvoteNode":"voteNode"),data:{nodeid:b,votetypeid:a},success:function(a){if(a.nodevotes){a=a.nodevotes;var c=d(`.js-reactions-toggle-vote[data-nodeid="${b}"]`);c.attr("data-deleteme",1);for(votetypekey in a)if(a.hasOwnProperty(votetypekey)){var f=a[votetypekey],l=parseInt(f.votetypeid,10),g=parseInt(f.votes,10);f=f.ivoted;var e=c.filter(`[data-votetypeid="${l}"]`),
h=e.length&&e.find(".js-reactions-count");if(l)if(e.length)e.data("ivoted",f),e.attr("data-ivoted",f),h.text(g),e.attr("data-deleteme",0==g?1:0);else if(0<g){{e=b;f=f?1:0;l=parseInt(l,10);e=parseInt(e,10);g=parseInt(g,10);h=d(`.js-reactions-dovote[data-votetypeid="${l}"]`);let a=h.html();g=h.length?`<div class="reactions__topic-reaction js-reactions-toggle-vote"
				data-ivoted="${f}"
				data-votetypeid="${l}"
				data-nodeid="${e}"
			>
			${a}<span class="reactions__topic-reaction--count js-reactions-count">${g}</span>
		</div>`:""}""!=g&&d(g).appendTo(d(`.js-topic-reactions-list[data-nodeid="${b}"]`))}}c.filter("[data-deleteme=1]").remove()}},api_error:function(a){return m.hasError(a,"nodevote_dupe_notallowed")?(console.log("TODO: implement flashAlreadyVoted()"),!1):!0},complete:()=>n()})}if(!k.reactionsinit){k.reactionsinit=!0;var c=d(".js-reactions-available-list"),m=k.ajaxtools,q=d(window);d(document).offon("click",".js-reactions-add-reaction",b=>{b=d(b.currentTarget);b.data("vb-reactions-list")||b.siblings(".js-reactions-available-list");
if(c)if(c.hasClass("vb-pop-open")&&c.data("nodeid")==b.data("nodeid"))n();else{var a=parseInt(b.data("nodeid"),10);c.data("nodeid",a);a=c;q.scrollTop();var h=b.offset().top+b.outerHeight(!0);h=Math.max(h-a.outerHeight(!0),q.scrollTop());var k="ltr"==pageData.textdirection;b=b.offset().left+(k?0:b.outerWidth(!0));a.css("top",h);k?a.css("left",b):a.css("right",b);c.toggleClass("vb-pop-open",!0)}return!1});d(document).on("click.reactions",b=>{n(d(".js-reactions-available-list.vb-pop-open"))});d(document).on("click.reactions",
".js-reactions-available-list",()=>!1);d(document).offon("click",".js-reactions-dovote",b=>{var a=d(b.currentTarget);b=parseInt(c.data("nodeid"),10);a=parseInt(a.data("votetypeid"),10);p(b,a)});d(document).offon("click",".js-reactions-toggle-vote",b=>{var a=d(b.currentTarget);b=parseInt(a.data("nodeid"),10);const c=parseInt(a.data("votetypeid"),10);a=a.hasClass("js-reactions-toggle-vote")&&a.data("ivoted");p(b,c,a)})}}Promise.all([vBulletin.ready("global")]).then(()=>{m(vBulletin,jQuery)})})();
;
